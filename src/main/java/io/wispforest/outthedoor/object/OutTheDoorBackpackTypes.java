...
public class OutTheDoorBackpackTypes implements AutoRegistryContainer<BackpackType> {
    ...
    public static final BackpackType LEATHER = new Type("leather", OutTheDoor.id("item/leather_backpack"));
    public static final BackpackType HIDE = new Type("hide", OutTheDoor.id("item/hide_backpack"));
    public static final BackpackType PUMPKIN = new Type("pumpkin", OutTheDoor.id("item/pumpkin_backpack"));
    ...
    public record Type(String name, Identifier model) implements BackpackType {}
}
